...
export { default as isWeakSet } from './checks/isWeakSet';
...
export { default as enforceWeakSet } from './enforcer/enforceWeakSet';
...
export { default as methodWeakSet } from './methods/methodWeakSet';
